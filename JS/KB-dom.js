...
light.addEventListener("click", function (event) {
    ...
    document.getElementById("zajímavosti").style.boxShadow = "1px solid rgba(0, 0, 0, 0.3)";
    ...
    document.getElementById("zajímavosti1").style.boxShadow = "1px solid rgba(0, 0, 0, 0.3)";
    ...
    document.getElementById("zajímavosti2").style.boxShadow = "1px solid rgba(0, 0, 0, 0.3)";
